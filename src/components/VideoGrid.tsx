...
export const VideoGrid: React.FC<VideoGridProps> = ({
  ...
  const [pressedVideo, setPressedVideo] = useState<number | 'create' | null>(
    null,
  );
        ...
        >
          <view
            style={{
              ...
              height: '100%',
              backgroundColor:
                pressedVideo === 'create' ? '#e8f4fd' : '#f0f8ff',
              borderRadius: '4px',
          ...
          >
            ...
            <view
              style={{
                ...
                bottom: 0,
                background:
                  'linear-gradient(135deg, rgba(255,107,157,0.1), rgba(78,205,196,0.1))',
                borderRadius: '4px',
              }}
            />
